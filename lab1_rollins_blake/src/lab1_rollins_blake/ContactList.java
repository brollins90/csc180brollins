...
/**
 * The ContactList is a container for the Contact objects.
 * Can load and Save the Contacts to a text file.
...
public class ContactList implements Iterable<Contact> {
	...
	public ContactList(String fileName) {
		...
		this.filePath = /*"C:\\_\\src\\Neumont\\CSC180-SB\\lab1_rollins_blake\\bin\\" + */fileName;
		loadFile();
	}
	...
	public void add(String name, String email, String phone) {
		this.add(name, email, phone, true);
	}
	 ...
	 */
	public void add(String name, String email, String phone, Boolean saveNewFile) {
		...
		if (this.filePath != null) {
			...
			try {
				...
				while ((line = br.readLine()) != null) {
					...
					if (parts.length == 3) {
						this.add(parts[0], parts[1], parts[2], false);
					} else {
